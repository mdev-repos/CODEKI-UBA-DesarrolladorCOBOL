      ...
      *    DATE-WRITTEN.  2025-MAYO-26.                                 
                                                                        
      *----------------------------------------------------------------*
      * ACTIVIDAD CLASE SINCRONICA 21 | CORTE DE CONTROL + ARCHIVO FBA *
      *----------------------------------------------------------------*
                                                                        
      *----------------------------------------------------------------*
      *  ESTE PROGRAMA REALIZA UN CORTE DE CONTROL POR TIPO DE DOCUME- *
      *  -NTO ( CLIS-TIP-DOC ) EN EL ARCHIVO CLIENTES.                 *
      ...
      *----------------------------------------------------------------*
       ...
       01  WS-TOTAL-TIPO.                                               
           ...
           02  FILLER          PIC X(19)   VALUE "* TOTAL TIPO DOC * ". 
           02  FILLER          PIC X(05)   VALUE SPACES.                
           02  TOTAL-TIPO      PIC ZZ9.                                 
           02  FILLER          PIC X(03) VALUE " | ".                   
      ...
      *----------------------------------------------------------------*
       ...
       01 CT-CONSTANTES.                                                
           02 CT-PROGRAMA                   PIC X(08)  VALUE 'PGMSIN21'.
      ...
      *----------------------------------------------------------------*
       ...
       01  WS-CONTROL-PAGINA.                                           
           02  WS-MAX-LINEAS                PIC 9(02)  VALUE 15.        
      ...
      *----------------------------------------------------------------*
       ...
       01 ACM-ACUMULADORES.                                             
           02 ACM-CONTADOR-DOC              PIC 9(03)  VALUE ZEROS.     
      ...
      *----------------------------------------------------------------*
       ...
       01 WS-CLAVE-ACT.                                                 
           02 WS-TIPO-DOC-ACT               PIC 9(02)  VALUE ZEROS.     
                                                                        
       01 WS-CLAVE-ANT.                                                 
           02 WS-TIPO-DOC-ANT               PIC 9(02)  VALUE ZEROS.     
      ...
      *----------------------------------------------------------------*
       ...
       1400-LEER-ENTRADA.                                               
           ...
           EVALUATE TRUE                                                
               WHEN FS-ENTRADA-OK                                       
                    MOVE CLIS-TIP-DOC         TO WS-TIPO-DOC-ACT        
      ...
      *----------------------------------------------------------------*
      *              2 6 0 0 - I M P R I M I R - C O R T E             *
      *----------------------------------------------------------------*
                                                                        
       2600-IMPRIMIR-CORTE.                                             
                                                                        
           MOVE '2600-IMPRIMIR-CORTE'         TO WS-PARRAFO.            
           ...
           MOVE ACM-CONTADOR-DOC     TO TOTAL-TIPO.                     
                                                                        
           WRITE LINEA-IMPRESION FROM WS-TOTAL-TIPO                     
              AFTER ADVANCING 1 LINE.                                   
           ...
           MOVE ZEROS TO ACM-CONTADOR-DOC.                              
