      ...
      *----------------------------------------------------------------*
      *   ACTIVIDAD CLASE SINCRONICA 18 | PGM CON VISAM ( ACT 02 )     *
      *----------------------------------------------------------------*
                                                                        
      *----------------------------------------------------------------*
      *  ESTE PROGRAMA LEE SECUENCIALMENTE EL ARCHIVO DE NOVEDADES (Q- *
      *  -SAM) Y COMPARA LA CLAVE CON EL ARCHIVO CLIENTES (VSAM) DE M- *
      *  -ANERA RANDOM.                                                *
      *  SI SE ENCUENTRA EL REGISTRO CON LA CLAVE LEIDA, MUESTRA EL T- *
      *  -IPO Y NUMERO DE DOCUMENTO MEDIANTE DISPLAY (SYSOUT).       - *
      *  EN CASO DE NO ENCONTRAR EL REGISTRO, REALIZA LA MISMA ACCION. *
      ...
      *----------------------------------------------------------------*
       ...
       01 CT-CONSTANTES.                                                
           02 CT-PROGRAMA                   PIC X(08)  VALUE 'PGSIN18B'.
      ...
      *----------------------------------------------------------------*
       ...
       2000-PROCESO.                                                    
           ...
           PERFORM 1600-BUSCAR-CLIENTE                                  
              THRU 1600-F-BUSCAR-CLIENTE.                               
      ...
      *----------------------------------------------------------------*
      *             1 6 0 0 - B U S C A R - C L I E N T E              *
      *----------------------------------------------------------------*
                                                                        
       1600-BUSCAR-CLIENTE.                                             
                                                                        
           MOVE '1600-BUSCAR-CLIENTE'         TO WS-PARRAFO.            
           ...
           EVALUATE TRUE                                                
               WHEN FS-CLIENTES-OK                                      
                 ...
                 DISPLAY ' '                                            
                 DISPLAY '* CLAVE DE NOVEDAD ENCONTRADA EN CLIENTE *'   
